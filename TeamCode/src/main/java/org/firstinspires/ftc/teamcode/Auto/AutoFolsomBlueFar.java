...
public class AutoFolsomBlueFar extends LinearOpMode {
    ...
    public void tripleShoot(Servo lift, DcMotorEx flywheel, DcMotor intakeMotor, double targetVelocity, long waitTime) throws InterruptedException {
        ...
        robot.control.turretMotor.setPower(-0.2);     // turn right on the Red side to hold turret
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.control.turretMotor.setPower(-0.2);     // turn right on the Blue side to hold turret while shooting
