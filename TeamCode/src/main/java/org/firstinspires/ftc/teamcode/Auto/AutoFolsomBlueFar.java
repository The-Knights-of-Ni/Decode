...
public class AutoFolsomBlueFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // first intake
        // TODO: Comeback to the same position
        ...
        // Second shot
        // ToDO: Comment out this if coming back to the starting position (above DriveToTarget call) as the RPM will be the same
        targetRPM = 2950;
        targetVelocity = targetRPM * TICKS_PER_REV / 60.0;
        voltage = battery.getVoltage();
        scaledF = BASE_F * (REFERENCE_VOLTAGE / voltage);
        flywheel.setPIDFCoefficients(
            DcMotor.RunMode.RUN_USING_ENCODER,
            new PIDFCoefficients(BASE_P, BASE_I, BASE_D, scaledF)
        );
