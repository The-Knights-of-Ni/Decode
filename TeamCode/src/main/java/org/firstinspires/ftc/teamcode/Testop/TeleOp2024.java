...
public class TeleOp2024 extends LinearOpMode {
    ...
    public enum Bucket {
        ...
        HIGH(5.31, -5.25);   //HIGH(5.31, -5.5) ==> 39" to the top
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.left_stick_y != 0) {
                ...
                double slValue = -gamepad1.left_stick_y * 0.7; // 0.41 this motor moves faster and needs to sync with sr
                double srValue = -gamepad1.left_stick_y * -0.7; // 0.41,  -0.5// 0.574, -0.7
    ...
    public void clawClose(Servo c){
        printClawPosition(c);
        // wait(1000);
        c.setPosition(0.09);     //0.09=.5" gap; smaller number = smaller gap
        printClawPosition(c);
    }
